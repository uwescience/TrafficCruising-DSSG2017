...
def aggregate(data,write_path = '../app/static/data/aggregated.txt',chart_path_1 = '../app/static/data/chart_data_fhv.json',chart_path_2 = '../app/static/data/chart_data_cruising.json', intersections_path = '../data/intersections.csv'):
